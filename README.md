...
const integer = 25;
const negative = -6;
const bigNumber = 1234567890123456;
console.log("Q2: This is a floating point number:", floatingPoint);
console.log("Q2: This is an integer:", integer);
console.log("Q2: This is a negative number:", negative);
...
console.log("Q3: The variable I made true is:", isStudent);
console.log("Q3: The variable I made false is:", isTeacher);
...
// PUT YOUR CODE HERE
const subtractionVariable = floatingPoint - integer;
const additionVariable = integer + negative;
...
console.log("Q13:", biggestStringLength(word1, word2));
console.log("Q13 empty string test:", biggestStringLength("", "Sonia"));
...
function shakeMagic8Ball() {
    const randomNumber = returnRandomNum();
